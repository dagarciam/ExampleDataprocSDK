...
import com.bbva.datioamproduct.fdevdatio.common.namings.input.Customers.{CustomerId, DeliveryId}
import com.bbva.datioamproduct.fdevdatio.common.namings.output.CustomersPhones.{Age, CustomerVip, ExtraDiscount, FinalPrice, JwkDate}
